      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-block py-1 px-3 rounded-full bg-slate-900 border border-slate-800 text-slate-400 text-xs font-semibold uppercase tracking-widest mb-4"
          >
            ...
            >
              ...
              <div className="p-8 relative z-10">
                <div className="w-12 h-12 rounded-lg bg-slate-800 border border-slate-700 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-brand-500/10 group-hover:border-brand-500/20 transition-all duration-300">
                  <service.icon className="w-6 h-6 text-slate-300 group-hover:text-brand-500 transition-colors" />
                </div>
                ...
                <div className="space-y-3">
                  {service.features.map((feature, idx) => (
                    <motion.div 
                      key={idx}
                      className="flex items-center gap-3 text-xs font-medium text-slate-500 group-hover:text-slate-300 transition-colors"
                    >
