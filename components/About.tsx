...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-slate-950 scroll-mt-32">
      <div className="container mx-auto px-6 max-w-4xl text-center">
        ...
        <h2 className="text-3xl font-bold mb-6 text-white">Qui est <span className="text-brand-500">Grow Your Business</span> ?</h2>
